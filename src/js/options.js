document.addEventListener('DOMContentLoaded', () => {
    ...
    deleteButton.addEventListener('click', function () {
      ...
      if (window.ExtCompat) {
        window.ExtCompat.storageGet('customParams', (result) => {
          ...
          window.ExtCompat.storageSet({ customParams });
        });
      } else {
  ...
  function saveSettings() {
    ...
    try {
      if (window.ExtCompat) {
        window.ExtCompat.storageSet({ language: language }, () => {
  ...
  function exportSettings() {
    try {
      if (window.ExtCompat) {
        window.ExtCompat.storageGet(['language', 'customParams'], (result) => {
          const settings = {
  ...
  function deleteCustomParam(name) {
    window.ExtCompat.storageGet('customParams', (result) => {
      ...
      window.ExtCompat.storageSet({ customParams: customParams }, () => {
